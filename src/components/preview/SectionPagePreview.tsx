    ...
    >
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 p-8 overflow-y-auto">
          ...
          {section.subtitle && (
            <p className="text-base mb-4" style={{ color: palette.text, opacity: 0.8 }}>
              {section.subtitle}
            </p>
          )}
          ...
          {section.pullQuote && (
            <div
              className="my-6 pl-4 border-l-4 italic text-lg"
          ...
          <div className="prose prose-sm max-w-none" style={{ color: palette.text }}>
            {section.bodyMarkdown.split('\n\n').map((paragraph, idx) => (
              <p key={idx} className="mb-3 leading-relaxed text-sm">
          ...
          {section.keyPoints.length > 0 && (
            <div className="mt-6">
              <h3 className="text-sm font-bold mb-3" style={{ color: palette.primary }}>
                Key Points
              </h3>
